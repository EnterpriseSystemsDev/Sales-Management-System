        ...
        return (
            <footer className="footer-distributed ">
                ...
                <div className="row" style={{fontFamily: 'sans-serif', color: '#D0D0D0'}}>
                    <div className="col-md-6 col-sm-12">
                        <div>
                            ...
                            <p style={{fontSize: 14}}>ShoesShop cam kết chất lượng cho tất cả sản phẩm bán tại cửa hàng
                                ShoesShop đều là hàng chính hãng, hoàn trả 100% tiền nếu phát hiện sản phẩm là Fake.</p>
                            <br/>
                            <p style={{marginBottom: 0}}>
                                <span style={{fontSize: 18}}>Phục vụ</span><br/>
                            </p>
                            <p style={{fontSize: 14}}>ShoesShop cam kết chất lượng phục vụ tốt nhất, chuyên nghiệp nhất
                                cho mọi khách hàng bằng chính sách hoàn tiền và tặng quà nếu nhân viên phục vụ quí khách
                                không chu đáo.</p>
                            <br/>
                            <p style={{marginBottom: 0}}>
                            ...
                            <p style={{fontSize: 14}}>
                                Nếu bạn gặp rắc rối về sản phẩm hay chất lượng dịch vụ của ShoesShop, hãy gọi ngay đến
                                số 0909080704 hoặc inbox ở fanpage <a
                                href="//facebook.com/ShoesShop">facebook.com/www.ShoesShop.com</a>
                            </p>
                        </div>
                    </div>
                    <div className="col-md-6 col-sm-12">
                        <div className="row">
                            <div className="col-md-6">
                                ...
                                <ul>
                                    ...
                                    <li><a
                                        href="https://docs.google.com/forms/d/e/1FAIpQLSeH7mfQMmLLV_dlGKrf-X5Y8CRlxr4shJ_un7JWsG_qaLmcSg/viewform">Gửi
                                        góp ý/Than phiền</a></li>
                                ...
                                <div className="left-aligned">
                                    ...
                                    <p style={{marginBottom: 0}}>
                                        <a style={{color: '#337ab7'}}
                                           href="https://docs.google.com/forms/d/e/1FAIpQLSeH7mfQMmLLV_dlGKrf-X5Y8CRlxr4shJ_un7JWsG_qaLmcSg/viewform">Than
                                            phiền/Chăm sóc khách hàng</a>
                                    </p>
                                </div>
                                <br/>
                                <h4>FAQ</h4>
                ...
                <div className="container-fluid">
                    <h3 style={{color: '#fff', textAlign: 'center', marginBottom: '3%', fontFamily: 'sans-serif'}}>Liên
                        Hệ</h3>
                    <div className="footer-left">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d313.1316745826296!2d106.70428083307314!3d10.771936743027254!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752f4137df72b7%3A0x1351d358bc2fe73!2zQklURVhDTywgTmfDtCDEkOG7qWMgS-G6vywgQuG6v24gTmdow6ksIFF14bqtbiAxLCBI4buTIENow60gTWluaCwgVmnhu4d0IE5hbQ!5e0!3m2!1svi!2s!4v1535455132345"
                            width="auto" height="250px" frameBorder={0} style={{border: 0}} allowFullScreen
                            title="location"/>
                    </div>
